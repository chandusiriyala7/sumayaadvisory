...
export default function ResearchPage() {
    ...
    return (
        <><section className="relative pt-32 md:pt-40 pb-16 md:pb-24 overflow-hidden bg-white">
            ...
            </section><section className="py-24 bg-slate-50 relative">
                <div className="container-custom relative z-10">
                    <SectionTitle
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-16">
                        {patents.map((patent, idx) => (
                            <div key={idx} className="group flex flex-col h-full">
                                <div className="flex-1 bg-white p-12 rounded-[3rem] border border-slate-200 shadow-sm group-hover:shadow-2xl transition-all duration-500 relative overflow-hidden">
                                    <div className="absolute top-0 right-0 p-8">
                                        <div className="text-5xl opacity-10 group-hover:opacity-20 transition-opacity">🏅</div>
                                    </div>
                                    <div className="inline-block px-4 py-1 bg-academic-gold-500/10 text-academic-gold-700 text-[10px] font-black uppercase tracking-widest rounded-full mb-6">
                                        Patent No. {patent.no}
                                    </div>
                                    <h4 className="text-2xl font-serif font-bold text-academic-blue-900 mb-6 leading-tight group-hover:text-academic-gold-600 transition-colors">
                                        {patent.title}
                                    </h4>
                                    ...
                                    <div className="pt-8 border-t border-slate-100 flex items-center justify-between">
                                        ...
                                        <span className="text-sm font-bold text-academic-blue-900">{patent.date}</span>
                                    </div>
                                </div>
                            </div>
                        ))}
                            ...
                            <div className="space-y-12">
                                ...
                                <div className="p-6 bg-white/5 rounded-2xl border border-white/10 group-hover:border-academic-gold-500/50 transition-colors">
                                    <div className="flex items-center justify-between mb-4">
                                        ...
                                        <span className="text-[10px] font-bold px-2 py-1 bg-academic-gold-500 text-academic-blue-950 rounded">2023</span>
                                    </div>
